...
export const en: Strings = {
  ...
  taskForm: {
    ...
    reminderPolicyInterval: 'Every X minutes',
    reminderIntervalAria: 'How often to remind, in minutes',
    minutesUnit: 'minutes',
    ...
    errorReminderInterval: 'The reminder frequency must be between 5 and 1440 minutes.',
