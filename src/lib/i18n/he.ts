...
export const he = {
  ...
  today: {
    ...
    groupActive: 'רלוונטי עכשיו',
    groupStartingToday: 'בהמשך היום',
    groupLate: 'באיחור',
    groupDue: 'להיום',
    groupSnoozed: 'מושהה',
  ...
  task: {
    ...
    activeUntil: (when: string) => `בתוקף עד ${when}`,
    scheduledFor: (when: string) => `מתחילה ב-${when}`,
    expiredAt: (when: string) => `פג תוקף ב-${when}`,
  ...
  taskForm: {
    ...
    typeRecurring: 'חוזרת',
    typeTimeLimited: 'מוגבלת בזמן',
    windowStart: 'תחילת החלון',
    windowEnd: 'סיום החלון',
    reminderPolicy: 'תזכורות בתוך החלון',
    reminderPolicyNone: 'ללא תזכורת',
    reminderPolicyStartOnly: 'בתחילת החלון בלבד',
    reminderPolicyInterval: 'כל X',
    reminderIntervalAria: 'תדירות התזכורות',
    minutesUnit: 'דקות',
    hoursUnit: 'שעות',
    reminderDailyIntervalAria: 'מספר הימים בין תזכורת לתזכורת',
    reminderDailyTimeLabel: 'שעת התזכורת היומית',
    reminderDailyTimeAria: 'שעת התזכורת היומית',
    finalReminderToggle: 'תזכורת נוספת לפני הפקיעה',
    finalReminderAria: 'כמה דקות לפני הסיום לשלוח תזכורת אחרונה',
    minutesBeforeEnd: 'דקות לפני הסיום',
    ...
    errorWindowOrder: 'סיום החלון צריך להיות אחרי תחילתו.',
    errorReminderIntervalMinutes: 'תדירות התזכורת צריכה להיות בין 5 ל-1440 דקות.',
    errorReminderIntervalHours: 'תדירות התזכורת צריכה להיות בין שעה אחת ל-72 שעות.',
    errorReminderDaily: 'התזכורת היומית צריכה לחזור כל 1 עד 30 ימים.',
    errorFinalReminder: 'התזכורת האחרונה צריכה להיות בין דקה ל-1440 דקות לפני הסיום.',
  },
  ...
  stats: {
    ...
    completionsCount: (n: number) => (n === 1 ? 'משימה אחת הושלמה' : `${tasksWord(n, 'he')} הושלמו`),
